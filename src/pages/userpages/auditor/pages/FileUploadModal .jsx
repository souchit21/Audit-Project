...
const FileUploadModal = () => {
    ...
    const handleFileChange = (event) => {
      ...
      const handleUpload = async(e) => {
        ...
        try{
          const response = await axios.post('https://07ec-103-68-187-186.ngrok-free.app/fileUpload/uploadChecklistAudit',formData);
      ...
      const submit = async(e)=>{
        e.preventDefault();
        const result = await axios.post('https://07ec-103-68-187-186.ngrok-free.app/audit/editAuditform',auditDetails);
