...
//   console.log('26', tokenArray);
  ...
  const handleVerificationStatusChange = (event, rowData) => {
    ...
    axios
      .post(`https://8702-103-68-187-186.ngrok-free.app/user/editVerificationStatus?id=${data.id}&verified=${data.verified}`)
      .then(result => {
  ...
  const PostToken = async(e)=>{
   ...
   // console.log('34', tokenArray)
    try{
    const result = await axios.get('https://8702-103-68-187-186.ngrok-free.app/user/nonVerifiedAccounts');
