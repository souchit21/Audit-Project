...
const AddnewChecklist = () => {
    ...
    const handleUpload = async(e) => {
      ...
      try{
        const response = await axios.post('https://6a66-103-68-187-186.ngrok-free.app/fileUpload/uploadChecklistAudit',formData);
    ...
    const submit = async(e)=>{
          e.preventDefault();
          const result = await axios.post('https://6a66-103-68-187-186.ngrok-free.app/checklist/addChecklist',auditDetails);
