...
const columns = [
  { id: 'id', label: 'ID', minWidth: 170, fontWeight:'bold', background:'#F6F9FC'},
  { id: 'name', label: 'Name', minWidth: 170, fontWeight:'bold', background:'#F6F9FC' },
  { id: 'code', label: 'ISO\u00a0Code', minWidth: 100, fontWeight:'bold', background:'#F6F9FC' },
  {
    id: 'population',
    label: 'Population',
    minWidth: 170,
